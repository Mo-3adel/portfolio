...
export const Nav1 = () => {     
    return (  
        ...
        <div className="flex justify-center w-auto mx-auto max-w-fit space-x-2.5 bg-gradient-to-r  from-cyan-600 to-violet-400 text-white p-3 font-bold rounded-2xl">
            <ul className="flex content-center justify-center space-x-4">
                <li><a href="#About" className="font-sans">About</a></li>
                <li><a href="#Experiance">Experiance</a></li>
                <li><a href="#Projects">Projects</a></li>                  
                <p1 className="border-r-2 border-blacks"></p1> 
